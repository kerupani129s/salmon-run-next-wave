...
- **(要確認)** ワイドローラー インク消費量 変更 **(対戦のみ？)**
- **(要確認)** スプラスピナー 塗り 変更 (対戦と共通)
- **(要確認)** ケルビン525 塗り 変更 (対戦と共通)
- **(要確認)** LACT-450 インク消費量 変更 **(対戦のみ？)**
- **(要確認)** バイト専用 N-ZAP85 ダメージ 28 から 30 へ変更
...
- ヴァリアブルローラー
	...
	- 縦振り インクロック時間 80F から 75F へ変更 (対戦と共通)
