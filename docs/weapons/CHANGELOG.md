...
- ダイナモローラー
	...
	- **(要確認)** ダメージ減衰 変更 (対戦と共通)
	- **(要確認)** インク消費量 変更 **(対戦のみ？)**
- **(要確認)** ホットブラスター 後隙 23F から 21F へ変更 (対戦と共通)
- **(要確認)** H3リールガン ダメージ 変更 **(対戦のみ？)**
- **(要確認)** スプラローラー インクロック時間 45F から 43F へ変更 (対戦と共通)
- **(要確認)** バレルスピナー 塗り 変更 (対戦と共通)
- **(要確認)** クアッドホッパーブラック 弾速 変更 (対戦と共通)
- **(要確認)** パラシェルター インク消費量 変更 **(対戦のみ？)**
- **(要確認)** S-BLAST92 短射程モード 遠爆風 ダメージ 半径 変更 (対戦と共通)

### スペシャルウェポン

- サメライド
	- **(要確認)** 表示 半径 変更 (対戦と共通)
	- **(要確認)** 近爆風 ダメージ 半径 変更 (対戦と共通)
	- **(要確認)** 中心位置 変更 (対戦と共通)
