...
- **(要確認)** スプラシューター 弾速および射程 変更 (対戦と共通)
- **(要確認)** プライムシューター ブレ 変更 (対戦と共通)
- **(要確認)** ノヴァブラスター 遠爆風 ダメージ 半径 変更 (対戦と共通)
- **(要確認)** L3リールガン インク消費量 変更 **(対戦のみ？)**
- **(要確認)** H3リールガン インク消費量 変更 **(対戦のみ？)**
- ソイチューバー
	- **(要確認)** フルチャージ チャージ時間 75F から 71F へ変更 (対戦と共通)
		- 変更前: チャージ時間含む DPS = 300 × 60F / (75F + 1F + 1F + 4F) = 222.2
		- 変更後: チャージ時間含む DPS = 300 × 60F / (71F + 1F + 1F + 4F) = 233.8
	- **(要確認)** 1 周チャージ チャージ時間 53F から 50F へ変更 (対戦と共通)
- **(要確認)** ガエンFF スライド後 硬直時間 45F から 42F へ変更 (対戦と共通)
- **(要確認)** スパイガジェット シェルター 復活時間 240F から 220F へ変更 (対戦と共通)
	- 240F × 1s / 60F = 4.0s
	- 220F × 1s / 60F = 3.7s
- **(要確認)** ドライブワイパー 縦斬り チャージ時間 16F から 14F へ変更 (対戦と共通)
