...
- ハイドラント
	- チャージ中 移動速度 変更 (対戦と共通)
	- 射撃継続時間 変更 (対戦と共通)
		- 変更前: フルチャージ 射撃継続時間 = (61 - 1) × 4F × 1s / 60F = 4s
...
- バイト専用 トライストリンガー 1 周チャージ ダメージ 75 から 100 へ変更
	- 変更前: DPS = 3 ×  75 × 60F / (30F + 1F + 1F + 13F) = 300
	- 変更後: DPS = 3 × 100 × 60F / (30F + 1F + 1F + 13F) = 400
	- 変更前: 合計ダメージ = 3 ×  75 = 225
...
- バイト専用 LACT-450
	...
	- 1 周チャージ ダメージ 50 から 70 へ変更
		- 変更前: DPS = 3 × 50 × 60F / (12F + 1F + 1F + 13F) = 333.3
		- 変更後: DPS = 3 × 70 × 60F / (12F + 1F + 1F + 13F) = 466.7
		- 変更前: 合計ダメージ = 3 × 50 = 150
		- 変更後: 合計ダメージ = 3 × 70 = 210
